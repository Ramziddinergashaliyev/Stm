  ...
  return (
    ...
    >
      ...
      <div className="news-card__body">
        ...
        <h3 className="news-card__body-title">
          {item.title}
        </h3>
      ...
      <main className="news-main container">
        <section className="news-section">
          <div className="news-section__label">
            <p className="news-section__label-title">Последние новости</p>
            <NavLink to={"/news"} className="news-section__label-btn">Все новости</NavLink>
          </div>
